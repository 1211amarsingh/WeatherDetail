...
public class HomeFragmentBindingImpl extends HomeFragmentBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.cv_your_amount, 1);
        sViewsWithIds.put(R.id.cv_your_transactions, 2);
        sViewsWithIds.put(R.id.tv_first_name, 3);
        sViewsWithIds.put(R.id.tv_email, 4);
        sViewsWithIds.put(R.id.tv_last_name, 5);
        sViewsWithIds.put(R.id.rvUser, 6);
    }
    // views
    @NonNull
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewmodel == variableId) {
            setViewmodel((com.kv.userweatherapp.presentation.user.HomeViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewmodel(@Nullable com.kv.userweatherapp.presentation.user.HomeViewModel Viewmodel) {
